...
public class InputReader {
	...
	public  void readInput() {
	  ...
	  public boolean validateCommand(String line)
	  {
		   ...
		   if ( commandArgs[0].compareToIgnoreCase("Q")==0 )
		 {
		   ...
		   if (this.simulator==null &&  commandArgs[0].compareToIgnoreCase("I")==1 )
		  {
  	    	  return false;

		  }
		  
		   if (commandArgs[0].toString()==null)
  	      {
  	    	  return false;
	  ...
	  public static void  showHelperMessage() {
		  ...
		  System.out.println("\033[1;35m [C|c]		Print current position of the pen and whether it is up or down and its\r\n"
		  		+ "facing direction\033[0m");
