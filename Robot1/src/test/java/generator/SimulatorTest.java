...
// 	}
// 	/**
// 	 * Test the otherCommand functionality with the command that does not exist in this method.
//      * @param currentcommand The command that the robot should do it. In this case, It is I.
//      * @return output. The command result.
//      * 
//      */ 
// 	 @Test
// 	 public void testOtherCommandI() {
// 			initialPosition = new Location(0, 0, Heading.NORTH, Mode.UP, arraysheet);
// 			robot.placeRobot(initialPosition, arraysheet);
// 			simulator.otherCommand(Command.I);
// 			assertEquals("UP", robot.getLocation().getMode().toString());
// 			assertEquals("NORTH", robot.getLocation().getHeading().toString());
