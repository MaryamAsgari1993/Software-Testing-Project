...
public class RobotTest extends TestCase {
	...
	private ArraySheet arraysheet1;
	@BeforeEach
	public void setUp() {
		robot = new Robot();
	 ...
	 /**
     * Testing the getArrayshet functionality.
     * @return ArraySheet an object from arraysheet class. In this case, It returns arraysheet(3,3). 
     */
	@Test
	 public void testGetArraySheet() {
		...
		robot.setArraySheet(mockarraysheet);
	    assertEquals(mockarraysheet, robot.getArraySheer());
	 }
