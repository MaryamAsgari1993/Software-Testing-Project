...
public class InputReader {
	...
	public static boolean showHelperMessage() {
		...
		System.out.println(
				"\033[1;35m [C|c]		Print current position of the pen and whether it is up or down and its facing direction\033[0m");
		System.out.println(
				"\033[1;35m [I n|i n]	Initialize the system: The values of the array floor are zeros and the robot is back to [0, 0], pen up and facing north. n size of the array, an integer greater than zero\033[0m");
